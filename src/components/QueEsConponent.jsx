...
export default function QueEsConponent() {
  return (
    <>
        <section className="">
            <div className="py-2 px-4 mx-auto max-w-screen-xl lg:py-6">
            <h1 className='text-4xl font-bold text-center mb-4 text-white' id='estrategia'>ESTRATEGIAS</h1>
            
                <div className="grid md:grid-cols-2 gap-8 text-white"> 
                    <div className="dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-4 md:p-6">
                        
                        <h2 className=" dark:text-white text-3xl font-extrabold mb-2">BootCamp</h2>
                    ...
                    <div className="dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-4 md:p-6">
                        ...
                        <h2 className="dark:text-white text-3xl font-extrabold mb-2 text-white">Hackathon </h2>
